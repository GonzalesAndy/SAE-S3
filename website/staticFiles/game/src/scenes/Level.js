class Level extends Phaser.Scene {
	...
	editorCreate() {
		...
		this.sceneScore = new Score(this);
		
		this.sceneScore.score = this.new_score;
		

		if(this.new_score ==undefined){
			this.new_score = 0;
			console.log(this.new_score)
		}
	...
	create() {
		...
		if(this.joueur.x = this.xDepart){
			this.sceneScore.increaseScore();
